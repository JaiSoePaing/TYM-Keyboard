...
public class ShanniKeyboard extends MyKeyboard {
    ...
    public ShanniKeyboard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
        // TODO Auto-generated constructor stub
    }

    public ShanniKeyboard(Context context, int layoutTemplateResId,
    ...
    public String handleShanNiInputText(int primaryCode, InputConnection ic) {
        ...
        if (MyConfig.isPrimeBookOn()) {
            return handleShanNiPrimeBook(primaryCode, ic, charcodeBeforeCursor);
        }
        return String.valueOf((char) primaryCode);
    }

    private String handleShanNiPrimeBook(int primaryCode, InputConnection ic,
                                         Integer charcodeBeforeCursor) {
    ...
    public void handleShanNiMoneySym(InputConnection ic) {
