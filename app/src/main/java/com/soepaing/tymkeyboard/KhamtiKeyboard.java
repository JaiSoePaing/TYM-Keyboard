...
public class KhamtiKeyboard extends MyKeyboard {
    ...
    public KhamtiKeyboard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
        // TODO Auto-generated constructor stub
    }

    public KhamtiKeyboard(Context context, int layoutTemplateResId,
    ...
    public String handleKhamtiInputText(int primaryCode, InputConnection ic) {
        ...
        Log.d("handleKhamtiInputText", "primeBook= " + MyConfig.isPrimeBookOn());
        if (MyConfig.isPrimeBookOn())
            return handleKhamtiTyping(primaryCode, ic);
        return String.valueOf((char) primaryCode);
    }

    private String handleKhamtiTyping(int primaryCode, InputConnection ic) {
        CharSequence charBeforeCursor = ic.getTextBeforeCursor(1, 0);
        // if getTextBeforeCursor return null, issues on version 1.1
        if (charBeforeCursor == null) {
            charBeforeCursor = "";
    ...
    public void handleKhamtiDelete(InputConnection ic) {
    ...
    public String khamtiVowel1() {
        char[] outText = {(char) 4226, (char) 4154};
        String outString = String.valueOf(outText);
        return outString;
    }

    public void handleKhamtiMoneySym(InputConnection ic) {
        // TODO Auto-generated method stub
