...
public class MyIME extends InputMethodService implements
        ...
        switch (MyConfig.getCurrentTheme()) {
            case 6:
                kv = (MyKeyboardView) getLayoutInflater().inflate(
                        R.layout.pink_keyboard, null);
                break;
            case 5:
                kv = (MyKeyboardView) getLayoutInflater().inflate(
                        R.layout.indigo_keyboard, null);
                break;
            case 4:
                kv = (MyKeyboardView) getLayoutInflater().inflate(
                        R.layout.purple_keyboard, null);
                break;
            case 3:
                kv = (MyKeyboardView) getLayoutInflater().inflate(
                        R.layout.green_keyboard, null);
                break;
            case 2:
                kv = (MyKeyboardView) getLayoutInflater().inflate(
                        R.layout.orange_keyboard, null);
                break;
            default:
                kv = (MyKeyboardView) getLayoutInflater().inflate(
                        R.layout.red_keyboard, null);
        }
    ...
    protected void onCurrentInputMethodSubtypeChanged(
        ...
        kv.setKeyboard(getKeyboard(Integer.parseInt(newSubtype.getExtraValue())));
        caps = false;
        shifted = false;
    ...
    private MyKeyboard getKeyboard(int subTypeId) {
        switch (subTypeId) {
            ...
            case 4:
                return new ShanniKeyboard(this, R.xml.shanni_qwerty);
            case 5:
                return new TaiLeKeyboard(this, R.xml.taile_qwerty);
            case 6:
                return new KhamtiKeyboard(this, R.xml.tai_khamti_qwery);
        }
    ...
    private MyKeyboard getSymKeyboard(int subTypeId) {
        switch (subTypeId) {
            ...
            case 4:
                return new ShanniKeyboard(this, R.xml.shanni_symbol);
            case 5:
                return new TaiLeKeyboard(this, R.xml.taile_symbol);
            case 6:
                return new KhamtiKeyboard(this, R.xml.tai_khamti_symbol);
        }
        return currentKeyboard;
    }
    ...
    private MyKeyboard getShiftedKeyboard(int subTypeId) {
        switch (subTypeId) {
            ...
            case 4:
                return new ShanniKeyboard(this, R.xml.shanni_shifted_qwerty);
            case 5:
                return new TaiLeKeyboard(this, R.xml.taile_shifted_qwerty);
            case 6:
                return new KhamtiKeyboard(this, R.xml.tai_khamti_shifted_qwery);
        }
        return currentKeyboard;
    }
    ...
    public void onKey(int arg0, int[] arg1) {
        ...
        switch (primaryCode) {
            case 42264154:// shan vowel
                ...
                unshiftByLocale();
                break;
            case 42264153:// khamti vowel
                ic.commitText(((KhamtiKeyboard) currentKeyboard).khamtiVowel1(), 1);
                unshiftByLocale();
                break;
            case 300001:
                switch (getLocaleId()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        ((ShanniKeyboard) currentKeyboard).handleShanNiMoneySym(ic);
                        break;
                    case 5:
                        ((TaiLeKeyboard) currentKeyboard).handleTaiLeMoneySym(ic);
                        break;
                    case 6:
                        ((KhamtiKeyboard) currentKeyboard).handleKhamtiMoneySym(ic);
                        break;
                }
                ...
                if (MyConfig.isPrimeBookOn()) {
                    ...
                    switch (getLocaleId()) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            ((ShanniKeyboard) currentKeyboard).handleShanNiDelete(ic);
                            break;
                        case 5:
                            ((TaiLeKeyboard) currentKeyboard).handleTaiLeDelete(ic);
                            break;
                        case 6:
                            ((KhamtiKeyboard) currentKeyboard).handleKhamtiDelete(ic);
                            break;
                        default:
                            deleteHandle(ic);
                    }
            ...
            default:
                ...
                switch (getLocaleId()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        cText = ((ShanniKeyboard) currentKeyboard).handleShanNiInputText(
                                primaryCode, ic);
                        break;
                    case 5:
                        cText = ((TaiLeKeyboard) currentKeyboard).handleTaiLeInputText(
                                primaryCode, ic);
                        break;
                    case 6:
                        cText = ((KhamtiKeyboard) currentKeyboard).handleKhamtiInputText(primaryCode, ic);
                        break;
                }
