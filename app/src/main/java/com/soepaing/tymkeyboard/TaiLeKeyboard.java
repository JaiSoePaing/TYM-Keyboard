...
public class TaiLeKeyboard extends MyKeyboard {
    ...
    public TaiLeKeyboard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
        // TODO Auto-generated constructor stub
    }

    public TaiLeKeyboard(Context context, int layoutTemplateResId,
    ...
    public String handleTaiLeInputText(int primaryCode, InputConnection ic) {
        ...
        Log.d("handleTaiLeInputText", "primeBook= " + MyConfig.isPrimeBookOn());
        if (MyConfig.isPrimeBookOn())
            return handleTaiLeTyping(primaryCode, ic);
        return String.valueOf((char) primaryCode);
    }

    private String handleTaiLeTyping(int primaryCode, InputConnection ic) {
        CharSequence charBeforeCursor = ic.getTextBeforeCursor(1, 0);
        // if getTextBeforeCursor return null, issues on version 1.1
        if (charBeforeCursor == null) {
            charBeforeCursor = "";
    ...
    public void handleTaiLeDelete(InputConnection ic) {
    ...
    public String taileVowel1() {
        char[] outText = {(char) 4226, (char) 4154};
        String outString = String.valueOf(outText);
        return outString;
    }

    public void handleTaiLeMoneySym(InputConnection ic) {
        // TODO Auto-generated method stub
